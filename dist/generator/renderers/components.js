...
function Component({ component, id }) {
    ...
    if (component.type === discord_js_1.ComponentType.Button) {
        return (react_1.default.createElement(discord_components_react_1.DiscordButton, { key: id, type: ButtonStyleMapping[component.style] || "secondary", url: (_a = component.url) !== null && _a !== void 0 ? _a : undefined, emoji: component.emoji ? (0, utils_1.parseDiscordEmoji)(component.emoji) : undefined }, component.label));
    }
    return undefined;
}
